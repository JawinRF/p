 ...
 * Replaces TFLiteClassifier.kt - same interface, no TFLite needed.
 *
 * Model file: assets/tinybert_prism.onnx
...
class OnnxClassifier(context: Context) {
    ...
    private fun tokenize(text: String): LongArray {
        ...
        tokens.forEachIndexed { i, token ->
            ids[i + 1] = token.hashCode().and(0x7FFF).toLong().coerceAtLeast(1L)
        }
